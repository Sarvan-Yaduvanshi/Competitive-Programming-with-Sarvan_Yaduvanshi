...
void solve() {
	...
	if (x == 0 && y == 0) println("Origem");
	else if (y == 0) println("Eixo X");
	else if (x == 0) println("Eixo Y");
	else if (x > 0 && y > 0) println("Q1");
	else if (x < 0 && y > 0) println("Q2");
	else if (x < 0 && y < 0) println("Q3");
	else println("Q4");
}
