...
void solve() {
    ...
    } else if (x <= 25) { // We already know x >= 0
        cout << "Interval [0,25]" << endl;
    } else if (x <= 50) { // We already know x > 25
        cout << "Interval (25,50]" << endl;
    } else if (x <= 75) { // We already know x > 50
        cout << "Interval (50,75]" << endl;
    } else { // The only case left is x > 75 and x <= 100
