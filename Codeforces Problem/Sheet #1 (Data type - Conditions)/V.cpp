...
void solve() {
	...
	// if (s == '>' && a > b || s == '<' && a < b || s == '=' && a == b) println("Right");
	// else println("Wrong");
	
	// 2. The Ternary Operator (A CP Favorite ⭐️)
	bool is_correct = (s == '>' && a > b) || (s == '<' && a < b) || (s == '=' && a == b);

    cout << (is_correct ? "Right" : "Wrong") << endl;
}
